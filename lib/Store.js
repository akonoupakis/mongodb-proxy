...
Store.prototype.run = function (event, previousData, data, cb) {
    ...
    if (_.isArray(scriptFns) && scriptFns.length > 0) {
        ...
        var taskProcess = function (d, prev, tcb) {
            var eventTasks = [];
            console.log(111, d, prev, previousData);
...
var inbound = function (object) {
    ...
    scrubber.when(function (x) {
        return typeof (x.value) === 'string' && uuid.isValid(x.value);
    }, function (x) {
        return uuid.create(x.value);
    });
...
var outbound = function (object) {
    ...
    scrubber.when(function (x) {
        ...
        if (!_.isArray(x.value) && _.isObject(x.value) && uuid.isValid(x.value))
