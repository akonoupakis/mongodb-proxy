...
var StoreClient = require('./Store.js');
var jsonValidation = require('json-validation');
var ApiClient = require('./Api.js');
...
Database.prototype.createStore = function (name) {
    var store = new StoreClient(this, name);
    return store;
};

Database.prototype.createApi = function () {
    var api = new ApiClient(this);
    return api;
};
