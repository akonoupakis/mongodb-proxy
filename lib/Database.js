 ...
 * @constructor
 * 
 * @param {Database~options} options - The config options. 
 * 
...
var Database = function (options) {
    ...
    * @param {Database~credentialOptions} credentials - The user credentials    
    */
      
    /**
    * @callback Database~credentialOptions
...
Database.prototype.configure = function (fn) {
    ...
    var processor = new DatabaseConfigProcessor();
    fn(processor);
};
...
Database.prototype.handle = function (route, next, cb) {
    ...
    * @param {string} [data] - The posted data (if any)
