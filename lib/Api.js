...
var Api = function (database, internal) {

    this.internal = internal;
    
    for (var collectionName in database.collections) {
        var collection = database.collections[collectionName];
        this[collection.name] = new CollectionApi(database, collection.name, this.internal);
    }
...
var CollectionApi = function (db, name, internal) {
    this.name = name;
    this.store = db.createStore(this.name, internal);
    this.internal = internal;
};
